...
$(".upload_pictures_bottom_btn").click(function(evt) {
	evt.preventDefault();
	if($(".upload_pictures_bottom_upload").attr("data-id") && $(".upload_pictures_bottom_upload").attr("data-id") != 'img/defaultHeadImg.jpg') {
			...
			if(data.success == true) {
				RequestService("/online/user/isAlive", "POST", null, function(t) {
					...
					if(t.resultObject.smallHeadPhoto) {
						if(t.resultObject.smallHeadPhoto!="img/defaultHeadImg.jpg"){

$(function () {
    ...
    var headersIndex={
        ...
        '<a href="/"><img src="/mhome/img/logoko.png" alt="" class="logoko"></a>'+
        '<div class="path">'+
        '<a href="/">云课堂</a>'+
        '<a href="#">问答精灵</a>'+
//      '<a href="/web/html/forum.html">博学社</a>'+
        ...
        '<div class="cymyloginlogo">欢迎登录&nbsp;&nbsp;安课云课堂</div>'+
    ...
    var slideNavIndex={
        ...
        '<img src="/mhome/img/zixun.gif.png" alt=""/><span>在线咨询</span>'+
        '</a></div>',
        phone_consult:'<div class="phone_consult">'+
        '<div class="phone_consult_box"><img src="/mhome/img/tel.gif.png" alt=""/><span class="dianhuazixun">电话咨询</span></div>' +
        ...
        '<span class="wrap">'+
        '<img src="/mhome/img/top.png" alt=""/><span class="h_top_s">top</span>'+
        '</span></div>'
    }
    //域名切换提示
//  var friend = '<div class="friendSee"><div class="friendSee-Body">' +
//  '<div class="friendSee-Body-left"><p style="margin-top:10px;">' + 
//  '<img src="/mhome/img/laba.png"/>' +
//  '<span class="friendSee-Body-title">域名切换通知</span>' +
//  '</p>' +
//  '<p class="friendSee-Body-text">温馨提示：各位院校合作的老师请注意，当前&nbsp;www.boxuegu.com&nbsp;已切换为【安课云课堂】使用，【安课院校】请访问地址&nbsp;yx.boxuegu.com</p>' +
//  '</div><div class="friendSee-Body-right"><a href="http://yx.boxuegu.com" target="_blank">点此过去</a></div>' + 
//  '<div class="closeSee"><img src="/mhome/img/close.png"></div>' +
//  '</div></div>';

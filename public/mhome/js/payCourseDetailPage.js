...
window.onload = function () {
    ...
    /*相关课程*/
    var relativeCourse =
        '<div class="relative-profession-top clearfix">' +
        '<span>推荐课程</span>' +
        ...
        "<p>暂无数据</p>" +
        "</div>" +
        '<div class="relative-profession-bottom slide-box clearfix">' +
        '<div id="box" class="slideBox clearfix">' +
        '<ul class="profession boxContent clearfix">' +
    ...
    var courseList = '{{each items}}' +
        ...
        '<div class="profession-time">报名截止时间：' + '<span>{{dataSub($value.curriculumTime)}}</span>' + '</div>' +
    ...
    RequestService("/grade/findGradeInfoByCourseId", "GET", {
        ...
        /*$('#detail-profession').html(template.compile(courseList)({
            items:data.resultObject
        }))*/
        RequestService("/profession/getCourseById", "POST", {
            courserId: courserId
        }, function (data) {
    ...
    $(".profession-problem").click(function () {
        $(".pages").css("display","none");
        RequestService("/profession/getCourseById", "GET", {
            courserId: courserId
        }, function (data) {
    ...
    $(".profession-outline").click(function () {
        $(".pages").css("display","none");
        RequestService('/profession/getCourseCatalog',"GET",{courseId:courserId},function(data){
    ...
    function Evalutation(){
        RequestService("/profession/findStudentCriticize",'GET',{
            courseId:courserId,
            ...
            if(data1.resultObject.items.length==0){
                ...
                RequestService("/profession/getGoodCriticizSum","GET",{courseId:courserId},function(data2){
    ...
    $(".profession-evaluate").click(function(){
        Evalutation();
    });
    $(".profession-details").click(function () {
        RequestService("/profession/getCourseById", "GET", {
            courserId: courserId
        }, function (data) {
    ...
    $(".profession-teacher").click(function () {
        RequestService("/lecturer/list/profession/" + courserId, "GET", "", function (data) {
            if(data.resultObject.length==0){
                $(".table-modal").html(template.compile(emptyDefaul));
            }else {
    ...
    RequestService("/profession/getRecommendCourseByCourseId", "GET", {
        courseId: courserId
    }, function (data) {
        $(".relative-profession").html(template.compile(relativeCourse)({
            item: data.resultObject
        }));

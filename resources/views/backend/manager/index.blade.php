...
@section('content')
	...
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管理员模块管理 <span class="c-gray en">&gt;</span> 管理员列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <!--a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a--> <a class="btn btn-primary radius" href="javascript:;" onclick="manager_add('添加管理员','{{ url('System/Manager/Add') }}','800')"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a> </span></div>
	...
	<script>
        ...
        $('.list-data').DataTable({
            ...
            "columns": [
                ...
                {'data':'mg_id',"defaultContent": "",'className':"text-c"},
            ...
            "createdRow": function(row,data,index){
                ...
                $(row).children().eq(-1).html(`<a title="编辑" href="javascript:;" onclick="manager_edit('编辑管理员信息','{{url('/System/Manager/Edit')}}/`+ data.mg_id +`' ,'`+ data.mg_id +`')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
				<a title="删除" href="javascript:;" onclick="manager_del(this,`+data.mg_id+`)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>`);
            },
        });
        /*学科-添加*/

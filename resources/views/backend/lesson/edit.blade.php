...
@section('content')
    ...
    <article class="page-container">
        <form action="{{ url('/System/Lesson/Save')}}/{{$id}}" method="post" class="form form-horizontal" id="lesson-add">
            {{ csrf_field() }}
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>课时标题：</label>
                <div class="formControls col-xs-4 col-sm-6">
                    <input type="text" class="input-text" name="lesson_name" value="{{$lesson->lesson_name}}" id="lesson_name">
                </div>
            </div>
            <div class="row cl">
          ...
          <select class="select" name="course_id" id="course_id">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <!-- 保存上传成功以后的图片地址 -->
                    <input type="hidden" name="cover" value="{{$lesson->cover}}">
                    <!-- 定义一个标签用来存放图片的预览图 -->
                    <div id="webuploader-img" style="margin-bottom: 5px;">
                        @if($lesson->cover)
                            <img src="{{config('program.url')}}/{{$lesson->cover}}" style="width:150px;height: 90px;">
                        @else
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <!-- 保存上传成功以后的图片地址 -->
                    <input type="hidden" name="video_address" value="{{$lesson->video_address}}">
                    <!-- 定义一个标签用来存放图片的预览图 -->
                    <div id="webuploader-video" style="margin-bottom: 5px;"> </div>
                    <!-- 上传进度条 -->
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <textarea name="lesson_desc" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true">
                        {{$lesson->lesson_desc}}
                    </textarea>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-4 col-sm-6">
                    <input type="text" class="input-text" value="{{$lesson->duration}}" name="duration" id="duration">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>排序：</label>
                <div class="formControls col-xs-4 col-sm-6">
                    <input type="text" class="input-text" name="sort" id="sort" value="{{$lesson->sort}}" placeholder="数值越大，越靠前！">
                </div>
            </div>
            <div class="row cl">

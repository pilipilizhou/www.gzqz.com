...
@section('content')
	<article class="page-container">
		<form action="{{ url('/System/Stream/Save') }}/{{$id}}" method="post" class="form form-horizontal" id="form-admin-role-add">
			{{ csrf_field() }}
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>流名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" id="stream_name" value="{{$stream->stream_name}}" name="stream_name">
				</div>
			</div>
			<div class="row cl">

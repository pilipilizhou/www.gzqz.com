...
@section('content')
	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-admin-store-add" action="{{ url('System/Subject/Save') }}/{{$id}}" method="post">
			{{csrf_field()}}
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学科名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="{{$subject->subject_name}}" placeholder="" id="subject_name" name="subject_name">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<div id="webuploader-img" style="margin-bottom: 1px;">
						@if($subject->logo)
						<img src="{{config('program.url')}}/{{$subject->logo}}" style="width:150px;height: 90px;">
						@else

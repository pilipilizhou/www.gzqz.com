...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i><a href="javascript:;" onclick="top.location.href='/System/Home/Index'">首页</a>  <span class="c-gray en">&gt;</span> 会员模块管理 <span class="c-gray en">&gt;</span> 会员列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script>
	...
	$('.list-data').DataTable({
    	...
    	{'data':'member_id',"defaultContent": "",'className':"text-c"},
		...
		"createdRow": function(row,data,index){
			...
			$(row).children().eq(-1).html(`<a title="编辑" href="javascript:;" onclick="member_edit('编辑会员信息','{{url('/System/Members/Edit')}}/`+ data.member_id +`' ,'`+ data.member_id +`')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
				<a title="删除" href="javascript:;" onclick="member_delete(this,`+data.member_id+`)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>`);
		},
	});

        ...
        <nav class="navbar container">
            ...
            <div class="navbar-left">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{{url('/Home/Live/Index')}}">课程</a></li>
                    <li><a href="#">职业测评</a></li>
                    <li><a href="#">学习中心</a></li>
                </ul>
            </div>
            <div class="navbar-left"><input type="text" class="input-search" placeholder="输入查询关键词"><input type="submit" class="search-buttom" value="查询"></div>
            <div class="navbar-right">
                @if($memberInfo)
                    {{$memberInfo}}
                @else
                    <a href="#" style="margin-right: 10px;">登录</a><a href="#">注册</a></div>
                @endif
        </nav>
    </div>
</header>
    ...
    <div class="conten-list">
        <div class="conten" id="a">
            <div class="row text-center top">
                <div class="col-lg-3 text-left" id="Title">编程入门</div>
                <div class="col-lg-5 ">
                    <div class="btn-group btn-group-justified">
            ...
            <div class="container cont-list">
                <div class="cont-list-roll">
                    ...
                    <div class="cont-list-box">
                        <li class="">
                            <img src="/home/img/page-1.jpg" alt="AA">
